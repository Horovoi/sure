...
class Api::V1::ValuationsController < Api::V1::BaseController
  ...
  def show
    ...
    Rails.logger.error "ValuationsController#show error: #{error.message}"
  ...
  def create
    ...
    Rails.logger.error "ValuationsController#create error: #{error.message}"
    Rails.logger.error error.backtrace.join("\n")
  ...
  def update
    ...
    Rails.logger.error "ValuationsController#update error: #{error.message}"
    Rails.logger.error error.backtrace.join("\n")
